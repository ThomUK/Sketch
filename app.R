...
ui <- fluidPage(
  ...
  div(class = "app-wrapper",
      ...
      div(class = "toolbar",
          ...
          tags$div(class = "colour-swatch", style = "background:#C0C0C0;",
                   title = "Blue",  onclick = "setColour('#C0C0C0', this)"),
          tags$div(class = "colour-swatch", style = "background:#0F52BA;",
                   title = "Blue",  onclick = "setColour('#0F52BA', this)"),
          tags$div(class = "colour-swatch", style = "background:#FF3131;",
                   title = "Red",   onclick = "setColour('#FF3131', this)"),
          tags$div(class = "colour-swatch", style = "background:#FFA500;",
                   title = "Blue",  onclick = "setColour('#FFA500', this)"),
          tags$div(class = "colour-swatch", style = "background:#32CD32;",
